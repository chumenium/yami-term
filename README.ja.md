...
- **マルチタブ** — 複数のシェルセッションをタブで管理。ドラッグ&ドロップで並べ替え可能。タブ名はプログラムがOSCシーケンスを送出した際に自動更新、またはタブをダブルクリックして手動でリネーム可能
...
### macOS: "yami-term"は壊れているため、開けません / 開発元を確認できません / マルウェアが含まれていないことを検証できませんでした
